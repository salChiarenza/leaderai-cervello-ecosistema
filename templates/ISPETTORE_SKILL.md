...
4. Confronta la versione installata con il `VERSION` vivo. Senza lettura o con
...
7. Ripara da solo file standard, ponti e puntatori mancanti. Elimina soltanto
...
8. Verifica memoria unica, ciclo report/log/stato, fonti business fuori dal
   codice, credenziali per solo percorso/history, asset firma/timbro e ordine
   stato-prossimo-scadenze nei file progetto.
9. Non fermarti al controllo dei file: prova almeno due percorsi reali
   `richiesta -> stanza -> fonte -> capacita/processo -> output`.
10. Completa il resoconto locale. Ogni invio esterno richiede autorizzazione
