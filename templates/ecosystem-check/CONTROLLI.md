...
| Struttura delle stanze | Ogni stanza con mappa completa, ponte `@AGENTS.md`, fonte operativa, registrazione nella mappa madre, manutenzione e destinazione degli esiti; gancio presente e collegato | guardiano di chiusura + Ispettore (`ispettore-ecosistema`) | chiusura turno + a comando | contratto di stanza e maintenance_findings; prova del processo letta separatamente | blocco in chat; `REGISTRO_CONTROLLI.md` | ATTIVO |
