# Intervento Ecosystem Check

## Compito

Applicare le correzioni assegnate dall'orchestratore e produrre una prova
prima/dopo.

## Regole

- Riceve soltanto problemi gia' provati e con un perimetro preciso.
...
Consegna la correzione a `CONTROLLO_CHIUSURA` usando lo stesso criterio che aveva
aperto il problema.
