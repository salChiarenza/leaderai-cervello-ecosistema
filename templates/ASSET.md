...
| Ispettore Ecosistema | Capacita | `Ecosistema per i clienti` su Google Drive, `CHECKUP.md` | Tutte | Censimento, riparazione e collaudo delle strade | ATTIVO | Skill dell'agente attivo | Non elimina contenuti preesistenti senza conferma |
